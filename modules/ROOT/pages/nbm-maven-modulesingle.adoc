...
If you don't have an image available, just save this image  `` link:maven-crud_abc16.png[abc16.png]``  ( 
image::maven-crud_abc16.png[title="16x16"] ) to your system and select the image after clicking Browse.
