...
[start=3]
1. Replace the default content of the file with the content found  link:paintapp_70_PaintCanvas.java[here]. If you named your package something other than  ``org.netbeans.paint`` , correct the package name in the Source editor.
