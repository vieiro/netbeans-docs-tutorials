...
The NetBeans Platform is a generic application framework primarily for Java
desktop applications. The main benefit of the NetBeans Platform is its
predefined modular architecture. Secondary benefits are the NetBeans Platform's
reusable solutions such as its docking framework and its out-of-the-box
pluggable components, in combination with the tools provided by its SDK,
NetBeans IDE, in particular its award winning "Matisse" GUI Builder for
designing GUI components.

In this quick start, you are introduced to the benefits and usages of modularity
on the Java desktop via a very simple example, contributed by Thomas Würthinger,
a PhD student at the Johannes Kepler University in Linz, Austria. Once you have
grasped the concepts introduced in this quick start, you will be ready to step
onto the xref:nbm-learning-trail.adoc[NetBeans Platform Learning Trail]
providing a very rich variety of tutorials for many different scenarios relating
to the NetBeans Platform.

NOTE: If you are new to the NetBeans Platform, it is highly recommended to get 
hold of one of the xref:nbm-learning-trail.adoc#books[NetBeans Platform Books].
...
* <<application,We will create the application.>>
* <<module,Then we will create a module>>
* <<window,We will add a window in this module>>
* <<run,And we will run tie application>>
...
image::nbm-quick-start/new-project-1.png[]
...
image::nbm-quick-start/new-project-2.png[]

Click btn:[Finish]. The new project appears as follows in the Projects window:


image::nbm-quick-start/new-project-3.png[]
...
image::nbm-quick-start/new-module-1.png[]

The New Module Project dialog will appear. 
Name the new module `WordEditorCore`:


image::nbm-quick-start/new-module-2.png[]
...
image::nbm-quick-start/new-window-1.png[]

The New File dialog appears. In the Module Development category, select "Window":

image::nbm-quick-start/new-window-2.png[]
...
image::nbm-quick-start/new-window-3.png[]
...
image::nbm-quick-start/new-window-6.png[]
...
image::nbm-quick-start/new-window-7.png[]
...
image::nbm-quick-start/new-app-1.png[]
...
image::/nbm-quick-start/new-api-4.png[]
...
image::nbm-quick-start/new-api-8.png[]
...
image::nbm-quick-start/new-api-9.png[]
...
image::nbm-quick-start/new-api-10.png[]
...
image::nbm-quick-start/new-impl-6.png[]

Click btn:[OK].

A confirmation dialog will appear:

image::nbm-quick-start/new-impl-7.png[]
...
image::nbm-quick-start/new-impl-8.png[]
...
image::nbm-quick-start/new-impl-9.png[]

Name the new class `UppercaseFilter`:

image::nbm-quick-start/new-impl-10.png[]
...
image::nbm-quick-start/new-impl-11.png[]

Add the WordEditorAPI dependency:

image::nbm-quick-start/new-impl-12.png[]

Expand the Libraries entries to verify the dependency as been added:

image::nbm-quick-start/new-impl-13.png[]
...
image::nbm-quick-start/new-impl-14.png[]
...
image::nbm-quick-start/new-impl-15.png[]
...
image::nbm-quick-start/new-history-1.png[]
...
image::nbm-quick-start/new-history-2.png[]
...
image::nbm-quick-start/new-history-3.png[]
...
image::nbm-quick-start/new-result-1.png[]
...
image::nbm-quick-start/new-result-2.png[]
