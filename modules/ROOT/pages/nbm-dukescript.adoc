...
image::install.png[] This will require a restart of the IDE.
...
image::wizard_5.png[] Click Finish.
...
The annotation  link:images[@Function] makes this method callable from the view. For example from a button click. We'll use it in the next section.
