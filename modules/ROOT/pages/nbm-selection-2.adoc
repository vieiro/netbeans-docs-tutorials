...
image::nbm-selection-2/explorer1.png[]
...
image::nbm-selection-2/result1.png[]
...
image::nbm-selection-2/result2.png[]
...
image::nbm-selection-2/result6.png[]

* *MenuView* - a `JButton` that pops up a menu of a Node and its children

image::nbm-selection-2/result7.png[]
...
image::nbm-selection-2/multiselect1.png[]
