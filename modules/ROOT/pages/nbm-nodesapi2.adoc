...
image::nbm-nodesapi2/html-display-1.png[]
...
image::nbm-nodesapi2/html-display-2.png[]
...
image::nbm-nodesapi2/html-display-3.png[]
...
image::nbm-nodesapi2/icon-in-project.png[]

In the Files view, it should look like this:

image::nbm-nodesapi2/icon-in-files.png[]
...
image::nbm-nodesapi2/icon-display-1.png[]
...
image::nbm-nodesapi2/icon-display-2.png[]
...
image::nbm-nodesapi2/action-display-1.png[]

When you select the menu item, the action is invoked:

image::nbm-nodesapi2/action-display-2.png[]
...
image::nbm-nodesapi2/action-display-3.png[]
...
image::nbm-nodesapi2/prop-display-1.png[]
...
image::nbm-nodesapi2/prop-display-2.png[]
...
image::nbm-nodesapi2/prop-display-3.png[]
...
image::nbm-nodesapi2/prop-display-4.png[]
...
image::nbm-nodesapi2/prop-display-5.png[]
