...
*  link:vislib_Category.java[Category.java]
*  link:vislib_CategoryChildren.java[CategoryChildren.java]
*  link:vislib_CategoryNode.java[CategoryNode.java]
*  link:vislib_PaletteSupport.java[PaletteSupport.java]
*  link:vislib_Shape.java[Shape.java]
*  link:vislib_ShapeChildren.java[ShapeChildren.java]
*  link:vislib_ShapeNode.java[ShapeNode.java]
